...
public class Intro : MonoBehaviour
{
    ...
    private void BGMLeft()
    {
        ...
        BGMUpdateUI();
        //브금 소리 줄이기
        AudioManager.Instance.SetBgmVolume(BgmCount * 0.1f);
    }
    ...
    private void SFXLeft()
    {
        SFXCount--;
        SFXUpdateUI();
        AudioManager.Instance.SetSfxVolume(SFXCount * 0.1f);
        //SFX 소리줄이기
    }
    ...
    private void SoundTalkLeft()
    {
        ...
        audio.float_talkSound = TalkSoundCount * 0.1f;
    ...
    {
        if (StartMenuCount == 0) { UnityEngine.SceneManagement.SceneManager.LoadScene("FlagFight"); }
