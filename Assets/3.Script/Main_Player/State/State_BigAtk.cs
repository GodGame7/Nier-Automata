...
public class State_BigAtk : State
{
    ...
    public override void Enter(State before)
    {
        ...
        Atk();
        Main_Player.Instance.anim_bigsword.SetTrigger("Atk");
    ...
    void ResetBool()
    {
        for (int i = 1; i <= 3; i++)
        {
            ...
            Main_Player.Instance.anim_player.SetBool("Big" + i, false);
            if (i <= 3)
            {
                Main_Player.Instance.anim_bigsword.SetBool("Atk" + i, false);
            }
        }
        Main_Player.Instance.anim_bigsword.ResetTrigger("Atk");
        Main_Player.Instance.anim_bigsword.ResetTrigger("ChargeEnd");
        Main_Player.Instance.anim_player.ResetTrigger("Atk");
        Main_Player.Instance.anim_player.ResetTrigger("ChargeEnd");
    ...
    {
        LoadBig();
        Main_Player.Instance.anim_bigsword.SetTrigger("ChargeEnd");
        Main_Player.Instance.anim_player.SetTrigger("ChargeEnd");
    }
    public void ChargeCancle()
    {
        LoadBig();
        Main_Player.Instance.anim_bigsword.SetTrigger("ChargeCancle");
        Main_Player.Instance.anim_player.SetTrigger("ChargeCancle");
    }
    void ResetStrong()
    {
    ...
    {
        LoadBig();
        Main_Player.Instance.anim_bigsword.SetBool("Atk" + i, true);
        Main_Player.Instance.anim_player.SetBool("Big" + i, true);
    }
